...
class _HomeScreenState extends State<HomeScreen> {
  ...
  _initChannel() async {
    Channel channel = await ApiService.instance.fetchChannel(channelId: 'UCYO_jab_esuFRV4b17AJtAw');
    setState(() {
      _channel = channel;
    });
  }
  ...
  _loadMoreVideos() async {
    _isLoading = true;
    List<Video> moreVideos = await ApiService.instance.fetchVideoFromPlaylist(playlistId: _channel.uploadPlayListId);
